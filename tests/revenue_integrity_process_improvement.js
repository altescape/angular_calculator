describe('calculator', function () {
  ...
  var var_revenue_integrity_proc_imp = element(by.id('var_revenue_integrity_proc_imp'));
  var var_revenue_integrity_proc_imp_high = element(by.id('var_revenue_integrity_proc_imp_high'));
  var ref1 = element(by.id('ref1'));
  var ref2 = element(by.id('ref2'));
  var ref3 = element(by.id('ref3'));
  var ref4 = element(by.id('ref4'));
  var ref5 = element(by.id('ref5'));
  var ref6 = element(by.id('ref6'));
  var ref7 = element(by.id('ref7'));
  var ref8 = element(by.id('ref8'));
  var ref9 = element(by.id('ref9'));
  var ref10 = element(by.id('ref10'));
  var ref11 = element(by.id('ref11'));
  var ref12 = element(by.id('ref12'));
  var ref13 = element(by.id('ref13'));

  var ref5_h = element(by.id('ref5_h'));
  var ref6_h = element(by.id('ref6_h'));
  var ref7_h = element(by.id('ref7_h'));
...
//  });
  ...
  it('should be able to enter numbers', function () {
    addNumbers();
  });
  ...
  // High value test
  it('var_revenue_integrity_proc_imp_high should equal 12', function () {
    expect(var_revenue_integrity_proc_imp_high.getText()).toEqual('12');
  });
