!function() {
    ...
    function G(a, b) {
        if (Aa && !aa && b && b.opacity !== t) b.filter = "alpha(opacity=" + 100 * b.opacity + ")";
        q(a.style, b);
    }
    ...
    ub = {
        ...
        I.HighchartsAdapter = I.HighchartsAdapter || a && {
            init: function(b) {
                ...
                e = a.cssHooks.opacity, a.extend(a.easing, {
                    ...
                    (k = e[b]) && (e[b] = function(c) {
                        var d, c = a ? c : this;
                        if ("align" !== c.prop) return d = c.elem, d.attr ? d.attr(c.prop, "cur" === b ? t : c.now) : k.apply(this, arguments); else return void 0;
                    });
                    ...
                    if (this[0]) {
                        if (Fa(b[0]) && (a = b[0], b = Array.prototype.slice.call(b, 1)), c = b[0], c !== t) c.chart = c.chart || {}, 
                        c.chart.renderTo = this[0], new R[a](c, b[1]), d = this;
            ...
            animate: function(b, c, d) {
                ...
                e.stop(), c.opacity !== t && b.attr && (c.opacity += "px"), e.animate(c, d);
            },
            stop: function(b) {
                a(b).stop();
            }
    ...
    P.prototype = {
        ...
        animate: function(a, b, c) {
            if (b = m(b, va, !0), bb(this), b) {
                if (b = w(b, {}), c) b.complete = c;
                kb(this, a, b);
        ...
        colorGradient: function(a, b, c) {
            ...
            f) {
                ...
                s = s.join(","), h[s] ? a = h[s].attr("id") : (g.id = a = "highcharts-" + tb++, 
                h[s] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], p(j, function(a) {
        ...
        attr: function(a, b) {
            ...
            if ("string" == typeof a && b !== t && (c = a, a = {}, a[c] = b), "string" == typeof a) g = (this[a + "Getter"] || this._defaultGetter).call(this, a, e); else {
                for (c in a) {
                    if (d = a[c], h = !1, this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c) && (f || (this.symbolAttr(a), 
        ...
        css: function(a) {
            ...
            if (e = !b, a && a.color) a.fill = a.color;
        ...
        align: function(a, b, c) {
            var d, e, f, g, h = {};
            if (e = this.renderer, f = e.alignedObjects, a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || Fa(c)) this.alignTo = d = c || "renderer", 
                ja(f, this), f.push(this), c = null;
            } else a = this.alignOptions, b = this.alignByTranslate, d = this.alignTo;
            if (c = m(c, e[d], e), d = a.align, e = a.verticalAlign, f = (c.x || 0) + (a.x || 0), 
            g = (c.y || 0) + (a.y || 0), "right" === d || "center" === d) f += (c.width - (a.width || 0)) / {
                right: 1,
                center: 2
            }[d];
            if (h[b ? "translateX" : "x"] = u(f), "bottom" === e || "middle" === e) g += (c.height - (a.height || 0)) / ({
                bottom: 1,
                middle: 2
            }[e] || 1);
            return h[b ? "translateY" : "y"] = u(g), this[this.placed ? "animate" : "attr"](h), 
        ...
        getBBox: function() {
            ...
            if (h && (a = b.cache[h]), !a) {
                ...
                if (b.isSVG) {
                    if (c = a.width, d = a.height, Aa && f && "11px" === f.fontSize && "16.9" === d.toPrecision(3)) a.height = d = 14;
        ...
        add: function(a) {
            ...
            if (this.parentInverted = a && a.inverted, void 0 !== this.textStr && b.buildText(this), 
            f) c.handleZ = !0, f = z(f);
            if (c.handleZ) for (a = d.childNodes, g = 0; g < a.length; g++) if (b = a[g], c = H(b, "zIndex"), 
            b !== e && (z(c) > f || !r(f) && r(c))) {
                d.insertBefore(e, b), h = !0;
                break;
            }
            if (h || d.appendChild(e), this.added = !0, this.onAdd) this.onAdd();
            return this;
        },
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                e = 1; i >= e; e++) {
                    if (f = g.cloneNode(0), h = 2 * i + 1 - 2 * e, H(f, {
                        isShadow: "true",
                        ...
                        fill: Q
                    }), c) H(f, "height", v(H(f, "height") - h, 0)), f.cutHeight = h;
                    b ? b.element.appendChild(f) : g.parentNode.insertBefore(f, g), d.push(f);
                }
                this.shadows = d;
            }
            return this;
    ...
    ta.prototype = {
        ...
        destroy: function() {
            var a = this.defs;
            if (this.box = null, this.boxWrapper = this.boxWrapper.destroy(), Oa(this.gradients || {}), 
            this.gradients = null, a) this.defs = a.destroy();
            return this.subPixelFix && W(I, "resize", this.subPixelFix), this.alignedObjects = null;
        },
        ...
        buildText: function(a) {
            ...
            !f && -1 === e.indexOf(" ") ? b.appendChild(y.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, 
            ...
            "" === e[e.length - 1] && e.pop(), p(e, function(e, f) {
                ...
                g = e.split("|||"), p(g, function(e) {
                    if ("" !== e || 1 === g.length) {
                        ...
                        " " !== e) {
                            if (m.appendChild(y.createTextNode(e)), n) o.dx = 0; else if (f && null !== j) o.x = j;
                            if (H(m, o), !n && f && (!aa && d && G(m, {
                                display: "block"
                            ...
                            $ = r > l, !$ || 1 === e.length ? (e = q, q = [], e.length && (t++, B && t * v > B ? (e = [ "..." ], 
                            a.attr("title", a.textStr)) : (m = y.createElementNS(xa, "tspan"), H(m, {
                                dy: v,
                                x: j
                            }), p && H(m, "style", p), b.appendChild(m), r > l && (l = r)))) : (m.removeChild(m.firstChild), 
                            q.unshift(e.pop())), e.length && m.appendChild(y.createTextNode(e.join(" ").replace(/- /g, "-")));
                        }
                    }
                });
            }));
        ...
        arc: function(a, b, c, d, e, f) {
            ...
            return a = this.symbol("arc", a || 0, b || 0, c || 0, c || 0, {
                innerR: d || 0,
                start: e || 0,
                end: f || 0
            }), a.r = c, a;
        ...
        text: function(a, b, c, d) {
            ...
            if (f.x = Math.round(b || 0), c) f.y = Math.round(c);
            if (a || 0 === a) f.text = a;
            if (a = this.createElement("text").attr(f), e && a.css({
                position: "absolute"
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                var a, b;
                if (a = s.element.style, J = (void 0 === Va || void 0 === wb || n.styles.textAlign) && s.textStr && s.getBBox(), 
                n.width = (Va || J.width || 0) + 2 * x + v, n.height = (wb || J.height || 0) + 2 * x, 
                na = x + o.fontMetrics(a && a.fontSize).b, z) {
                    if (!m) a = u(-L * x), b = h ? -na : 0, n.box = m = d ? o.symbol(d, a, b, n.width, n.height, B) : o.rect(a, b, n.width, n.height, 0, B[Pb]), 
                    m.attr("fill", Q).add(n);
                    m.isImg || m.attr(q({
                        width: u(n.width),
                        height: u(n.height)
            ...
            function k() {
                ...
                if (c = h ? 0 : na, r(Va) && J && ("center" === a || "right" === a)) b += {
                    center: .5,
                    right: 1
                }[a] * (Va - J.width);
        ...
        htmlCss: function(a) {
            ...
            return this.styles = q(this.styles, a), G(this.element, a), this;
        },
        htmlGetBBox: function() {
            var a = this.element, b = this.bBox;
            if (!b) {
                if ("text" === a.nodeName) a.style.position = "absolute";
                b = this.bBox = {
                    x: a.offsetLeft,
                    y: a.offsetTop,
                    width: a.offsetWidth,
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (G(b, {
                    ...
                    if (o !== this.cTT) {
                        if (k = a.fontMetrics(b.style.fontSize).b, r(j) && this.setSpanRotation(j, h, k), 
    ...
    if (!aa && !fa) {
        R.VMLElement = X = {
            init: function(a, b) {
                ...
                if (("shape" === b || e) && d.push("left:0;top:0;width:1px;height:1px;"), d.push("visibility: ", e ? "hidden" : "visible"), 
            ...
            add: function(a) {
                ...
                if (a && a.inverted && b.invertChild(c, d), d.appendChild(c), this.added = !0, this.alignOnAdd && !this.deferUpdateTransform && this.updateTransform(), 
            ...
            pathToVML: function(a) {
                for (var b = a.length, c = []; b--; ) if (ha(a[b])) c[b] = u(10 * a[b]) - 5; else if ("Z" === a[b]) c[b] = "x"; else if (c[b] = a[b], 
            ...
            cutOffPath: function(a, b) {
                var c, a = a.split(/[ ,]/);
                if (c = a.length, 9 === c || 11 === c) a[c - 4] = a[c - 2] = z(a[c - 2]) - 10 * b;
                return a.join(" ");
            },
            shadow: function(a, b, c) {
                var e, h, j, l, o, n, s, d = [], f = this.element, g = this.renderer, i = f.style, k = f.path;
                if (k && "string" != typeof k.value && (k = "x"), o = k, a) {
                    for (n = m(a.width, 3), s = (a.opacity || .15) / n, e = 1; 3 >= e; e++) {
                        if (l = 2 * n + 1 - 2 * e, c && (o = this.cutOffPath(k.value, l + .5)), j = [ '<shape isShadow="true" strokeweight="', l, '" filled="false" path="', o, '" coordsize="10 10" style="', f.style.cssText, '" />' ], 
                        h = Y(g.prepVML(j), null, {
                            left: z(i.left) + m(a.offsetX, 1),
                            top: z(i.top) + m(a.offsetY, 1)
                        }), c) h.cutOff = l + 1;
                        j = [ '<stroke color="', a.color || "black", '" opacity="', s * e, '"/>' ], Y(g.prepVML(j), null, null, h), 
                        b ? b.element.appendChild(h) : f.parentNode.insertBefore(h, f), d.push(h);
                    }
                    this.shadows = d;
                }
                return this;
            ...
            fillSetter: function(a, b, c) {
                var d = c.nodeName;
                if ("SPAN" === d) c.style.color = a; else if ("IMG" !== d) c.filled = a !== Q, this.setAttr("fillcolor", this.renderer.color(a, c, b, this));
            },
            opacitySetter: sa,
        ...
        var ga = {
            ...
            color: function(a, b, c, d) {
                ...
                } else if (g.test(a) && "IMG" !== b.tagName) f = ya(a), h = [ "<", c, ' opacity="', f.get("a"), '"/>' ], 
                Y(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
                    if (j = b.getElementsByTagName(c), j.length) j[0].opacity = 1, j[0].type = "solid";
                    j = a;
                }
                return j;
            },
            ...
            circle: function(a, b, c) {
                ...
                return d.isCircle = !0, d.r = c, d.attr({
                    x: a,
                    y: b
                });
            },
            ...
            symbols: {
                arc: function(a, b, c, d, e) {
                    ...
                    if (g - f === 0) return [ "x" ]; else return f = [ "wa", a - h, b - h, a + h, b + h, a + h * d, b + h * i, a + h * j, b + h * k ], 
    ...
    Sa.prototype = {
        addLabel: function() {
            ...
            if (a.isDatetimeAxis && o && (l = b.dateTimeLabelFormats[o.higherRanks[g] || o.unitName]), 
            this.isFirst = j, this.isLast = k, b = a.labelFormatter.call({
                ...
                if (l = {
                    align: a.labelAlign
                }, ha(h.rotation)) l.rotation = h.rotation;
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            ...
            if (n && 2 === i.side && (b -= o - o * Z(n * Ca)), !r(e.y) && !n && (b += o - c.getBBox().height / 2), 
        ...
        render: function(a, b, c) {
            ...
            if (this.isActive = !0, s) {
                if (j = d.getPlotLinePath(j + u, s * B, b, !0), l === t) {
                    if (l = {
                        stroke: p,
                        "stroke-width": s
                    }, J) l.dashstyle = J;
            ...
            if (o && L) "inside" === r && (L = -L), d.opposite && (L = -L), h = this.getMarkPath(y, w, L, o * B, g, f), 
            n ? n.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(y)) i.xy = w = this.getLabelPosition(y, w, i, g, k, u, a, v), this.isFirst && !this.isLast && !m(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !m(e.showLastLabel, 1) ? q = !1 : !d.isRadial && !k.step && !k.rotation && !b && 0 !== c && (q = this.handleOverflow(a, w)), 
        ...
        if (this.axis = a, b) this.options = b, this.id = b.id;
        ...
        render: function() {
            ...
            if (b.isLog && (j = za(j), i = za(i), l = za(l)), h) {
                if (s = b.getPlotLinePath(l, h), q = {
                    stroke: J,
                    "stroke-width": h
                }, o) q.dashstyle = o;
            } else if (k) {
                if (j = v(j, b.min - d), i = C(i, b.max + d), s = b.getPlotBandPath(j, i, e), J) q.fill = J;
            ...
            if (n) {
                if (s) n.animate({
                    d: s
                }, null, n.onGetPath); else if (n.hide(), n.onGetPath = function() {
                    n.show();
        ...
        init: function(a, b) {
            ...
            if (-1 === Da(this, a.axes) && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), 
        ...
        getSeriesExtremes: function() {
            ...
            p(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    var e;
                    if (a.hasVisibleSeries = !0, a.isLog && 0 >= d && (d = null), a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = C(m(a.dataMin, d[0]), Na(d)), a.dataMax = v(m(a.dataMax, d[0]), Ba(d));
                    } else {
                        if (c.getExtremes(), e = c.dataMax, c = c.dataMin, r(c) && r(e)) a.dataMin = C(m(a.dataMin, c), c), 
                        a.dataMax = v(m(a.dataMax, e), e);
                        if (r(d)) if (a.dataMin >= d) a.dataMin = d, a.ignoreMinPadding = !0; else if (a.dataMax < d) a.dataMax = d, 
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            if (!i) i = this.transA;
            if (c) g *= -1, h = this.len;
            return this.reversed && (g *= -1, h -= g * (this.sector || this.len)), b ? (a = a * g + h, 
            a -= j, a = a / i + d, e && (a = this.lin2val(a))) : (e && (a = this.val2lin(a)), 
            "between" === f && (f = .5), a = g * (a - d) * i + h + g * j + (ha(f) ? i * f * this.pointRange : 0)), 
            a;
        },
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            if (i = this.transB, e = m(e, this.translate(a, null, null, c)), a = c = u(e + i), 
            i = j = u(k - e - i), isNaN(e)) o = !0; else if (this.horiz) {
                if (i = h, j = k - this.bottom, g > a || a > g + this.width) o = !0;
            } else if (a = g, c = l - this.right, h > i || i > h + this.height) o = !0;
        ...
        adjustForMinRange: function() {
            ...
            if (this.isXAxis && this.minRange === t && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null : (p(this.series, function(a) {
                for (i = a.xData, g = j = a.xIncrement ? 1 : i.length - 1; g > 0; g--) if (h = i[g] - i[g - 1], 
                f === t || f > h) f = h;
            }), this.minRange = C(5 * f, this.dataMax - this.dataMin));
            if (c - b < this.minRange) {
                var k = this.minRange;
                if (d = (k - c + b) / 2, d = [ b - d, m(a.min, b - d) ], e) d[2] = this.dataMin;
                if (b = Ba(d), c = [ b + k, m(a.max, b + k) ], e) c[2] = this.dataMax;
                c = Na(c), k > c - b && (d[0] = c - k, d[1] = m(a.min, c - k), b = Ba(d));
            }
        ...
        setAxisTranslation: function(a) {
            ...
            if (a) b.oldTransA = j;
            b.translationSlope = b.transA = j = b.len / (c + g || 1), b.transB = b.horiz ? b.left : b.bottom, 
        ...
        setTickPositions: function(a) {
            ...
            if (h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), 
            b.min = m(c.min, c.dataMin), b.max = m(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ra(11, 1)) : (b.min = m(b.userMin, d.min, b.dataMin), 
            b.max = m(b.userMax, d.max, b.dataMax)), e) !a && C(b.min, m(b.dataMin, b.min)) <= 0 && ra(10, 1), 
            b.min = da(za(b.min)), b.max = da(za(b.max));
            if (b.range && r(b.max)) b.userMin = b.min = v(b.min, b.max - b.range), b.userMax = b.max, 
            b.range = null;
            if (b.beforePadding && b.beforePadding(), b.adjustForMinRange(), !$ && !b.axisPointRange && !b.usePercentage && !h && r(b.min) && r(b.max) && (c = b.max - b.min)) {
            ...
            if (b.min === b.max || void 0 === b.min || void 0 === b.max ? b.tickInterval = 1 : h && !l && n === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = m(l, $ ? 1 : (b.max - b.min) * n / v(b.len, n)), 
            ...
            if (b.minorTickInterval = "auto" === d.minorTickInterval && b.tickInterval ? b.tickInterval / 5 : d.minorTickInterval, 
            ...
            s && a.splice(1, a.length - 2), b.tickPositions = a;
        ...
        setScale: function() {
            ...
            this.setAxisSize(), e = this.len !== this.oldAxisLength, p(this.series, function(a) {
                ...
                if (this.forceRedraw = !1, this.getSeriesExtremes(), this.setTickPositions(), this.oldUserMin = this.userMin, 
        ...
        getOffset: function() {
            ...
            if (n && n.text && n.enabled !== !1) {
                ...
                a.axisTitle.isNew = !0;
                if (b) k = a.axisTitle.getBBox()[g ? "height" : "width"], o = m(n.margin, g ? 5 : 10), 
                l = n.offset;
                a.axisTitle[b ? "show" : "hide"]();
            }
            a.offset = x * m(d.offset, J[h]), a.axisTitleMargin = m(l, $ + o + ($ && x * d.labels[g ? "y" : "x"] - na)), 
            J[h] = v(J[h], a.axisTitleMargin + k + x * a.offset), L[i] = v(L[i], 2 * T(d.lineWidth / 2));
        },
        ...
        render: function() {
            ...
            if (a.labelEdge.length = 0, a.justifyToPlot = "justify" === w, p([ l, o, n ], function(a) {
                for (var b in a) a[b].isActive = !1;
            }), q || h) if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function(b) {
                o[b] || (o[b] = new Sa(a, b, "minor")), x && o[b].isNew && o[b].render(null, !0), 
                o[b].render(null, !1, 1);
            }), i.length && (j = i.slice(), (b && c || !b && !c) && j.reverse(), y && (j = j.slice(1).concat([ j[0] ])), 
            p(j, function(b, c) {
                if (y && (c = c === j.length - 1 ? 0 : c + 1), !h || b >= a.min && b <= a.max) l[b] || (l[b] = new Sa(a, b)), 
                x && l[b].isNew && l[b].render(c, !0, .1), l[b].render(c, !1, 1);
            }), J && 0 === a.min && (l[-1] || (l[-1] = new Sa(a, -1, null, !0)), l[-1].render(-1))), 
            m && p(i, function(b, c) {
                if (c % 2 === 0 && b < a.max) n[b] || (n[b] = new R.PlotLineOrBand(a)), u = b + J, 
            ...
            s && s.enabled && a.renderStackTotals(), a.isDirty = !1;
        },
        redraw: function() {
        ...
        drawCrosshair: function(a, b) {
            if (this.crosshair) if ((r(b) || !m(this.crosshair.snap, !0)) === !1) this.hideCrosshair(); else {
                ...
                if (m(d.snap, !0) ? r(b) && (c = this.chart.inverted != this.horiz ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, 
        ...
        if (r(b)) {
            if (j >= A.second && (i.setMilliseconds(0), i.setSeconds(j >= A.minute ? 0 : k * T(i.getSeconds() / k))), 
            j >= A.minute) i[Db](j >= A.hour ? 0 : k * T(i[pb]() / k));
            if (j >= A.hour) i[Eb](j >= A.day ? 0 : k * T(i[qb]() / k));
            if (j >= A.day) i[sb](j >= A.month ? 1 : k * T(i[Xa]() / k));
            if (j >= A.month && (i[Fb](j >= A.year ? 0 : k * T(i[fb]() / k)), h = i[gb]()), 
            j >= A.year && (h -= h % k, i[Gb](h)), j === A.week) i[sb](i[Xa]() - i[rb]() + m(d, 1));
        ...
        if (a >= .5) a = u(a), g = this.getLinearTickPositions(a, b, c); else if (a >= .08) for (var h, i, j, k, l, f = T(b), e = a > .3 ? [ 1, 2, 4 ] : a > .15 ? [ 1, 2, 4, 6, 8 ] : [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]; c + 1 > f && !l; f++) for (i = e.length, 
        h = 0; i > h && !l; h++) j = za(ia(f) * e[h]), j > b && (!d || c >= k) && g.push(k), 
        k > c && (l = !0), k = j; else if (b = ia(b), c = ia(c), a = e[d ? "minorTickInterval" : "tickInterval"], 
    ...
    Mb.prototype = {
        ...
        hide: function() {
            var b, a = this;
            if (clearTimeout(this.hideTimer), !this.isHidden) b = this.chart.hoverPoints, this.hideTimer = setTimeout(function() {
        ...
        getPosition: function(a, b, c) {
            var g, d = this.chart, e = this.distance, f = {}, h = [ "y", d.chartHeight, b, c.plotY + d.plotTop ], i = [ "x", d.chartWidth, a, c.plotX + d.plotLeft ], j = c.ttBelow || d.inverted && !c.negative || !d.inverted && c.negative, k = function(a, b, c, d) {
                ...
                if (d += e, j && b) f[a] = d; else if (!j && g) f[a] = c; else if (g) f[a] = c; else if (b) f[a] = d; else return !1;
            }, l = function(a, b, c, d) {
                if (e > d || d > b - e) return !1; else f[a] = c / 2 > d ? 1 : d > b - c / 2 ? b - c - 2 : d - c / 2;
            }, o = function(a) {
                var b = h;
                h = i, i = b, g = a;
            }, n = function() {
        ...
        refresh: function(a, b) {
            ...
            g = this.getAnchor(a, b), f = g[0], g = g[1], l && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, 
            h && p(h, function(a) {
                a.setState();
            }), p(a, function(a) {
                ...
                x: a[0].category,
                y: a[0].y
            }, h.points = j, this.len = j.length, a = a[0]) : h = a.getLabelConfig(), i = i.call(h, this), 
            h = a.series, this.distance = m(h.tooltipOptions.distance, 16), i === !1 ? this.hide() : (this.isHidden && (bb(d), 
    ...
    if (Wa.prototype = {
        init: function(a, b) {
            ...
            if (this.options = b, this.chart = a, this.zoomX = f = /x/.test(e), this.zoomY = e = /y/.test(e), 
        ...
        normalize: function(a, b) {
            ...
            if (d = a.touches ? a.touches.length ? a.touches.item(0) : a.changedTouches[0] : a, 
            !b) this.chartPosition = b = Rb(this.chart.container);
            return d.pageX === t ? (c = v(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, 
            d = d.pageY - b.top), q(a, {
                chartX: u(c),
                chartY: u(d)
            });
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                for (f = [], i = c.length, j = 0; i > j; j++) if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = M(l - e.clientX), 
            ...
            if (c = h && h.tooltipOptions.followPointer, h && h.tracker && !c) {
        ...
        reset: function(a) {
            ...
            if ((a = a && e && f) && qa(f)[0].plotX === t && (a = !1), a) e.refresh(f), d && d.setState(d.state, !0); else {
                if (d) d.onMouseOut();
                if (c) c.onMouseOut();
                if (e && e.hide(), this._onDocumentMouseMove) W(y, "mousemove", this._onDocumentMouseMove), 
        ...
        drag: function(a) {
            ...
            if (h > d ? d = h : d > h + j && (d = h + j), i > e ? e = i : e > i + k && (e = i + k), 
            this.hasDragged = Math.sqrt(Math.pow(o - d, 2) + Math.pow(n - e, 2)), this.hasDragged > 10) {
                if (l = b.isInsidePlot(o - h, n - i), b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !this.selectionMarker) this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({
        ...
        inClass: function(a, b) {
            for (var c; a; ) {
                if (c = H(a, "class")) if (-1 !== c.indexOf(b)) return !0; else if (-1 !== c.indexOf("highcharts-container")) return !1;
                a = a.parentNode;
            }
        },
        ...
        pinch: function(a) {
            ...
            if ((i || e) && !l && a.preventDefault(), Ua(f, function(a) {
            ...
            p(c.axes, function(a) {
                ...
                b.pinchTranslate(d, f, k, j, o, h), b.hasPinched = i, b.scaleGroups(k, o), !i && e && 1 === g && this.runPointActions(b.normalize(a));
            }
        },
        ...
        var ua = {}, zb = !!I.PointerEvent, Wb = function() {
            ...
            if (a = a.originalEvent || a, ("touch" === a.pointerType || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && V[oa]) d(a), 
            d = V[oa].pointer, d[b]({
                type: c,
    ...
    lb.prototype = {
        init: function(a, b) {
            ...
            if (this.options = b, b.enabled) c.baseline = z(d.fontSize) + 3 + f, c.itemStyle = d, 
        ...
        positionItem: function(a) {
            ...
            if (a.legendGroup && a.legendGroup.translate(b ? e : this.legendWidth - e - 2 * c - 4, d), 
            f) f.x = e, f.y = d;
        },
        ...
        renderItem: function(a) {
            ...
            this.colorizeItem(a, a.visible), x && this.createCheckboxForItem(a);
            if (c = q.getBBox(), f = a.checkboxOffset = d.itemWidth || a.legendItemWidth || f + g + c.width + k + (x ? 20 : 0), 
            this.itemHeight = g = u(a.legendItemHeight || c.height), e && this.itemX - p + f > (o || b.chartWidth - 2 * j - p - d.x)) this.itemX = p, 
            this.itemY += s + this.lastLineHeight + n, this.lastLineHeight = 0;
            this.maxItemWidth = v(this.maxItemWidth, f), this.lastItemY = s + this.itemY + n, 
            this.lastLineHeight = v(g, this.lastLineHeight), a._legendItemPos = [ this.itemX, this.itemY ], 
            e ? this.itemX += f : (this.itemY += s + g + n, this.lastLineHeight = g), this.offsetWidth = o || v((e ? this.itemX - p - k : f) + j, this.offsetWidth);
        },
        getAllItems: function() {
            var a = [];
            return p(this.chart.series, function(b) {
                var c = b.options;
                if (m(c.showInLegend, !r(c.linkedTo) ? t : !1, !0)) a = a.concat(b.legendItems || ("point" === c.legendType ? b.data : b));
            }), a;
        },
        render: function() {
            var e, f, g, h, a = this, b = a.chart, c = b.renderer, d = a.group, i = a.box, j = a.options, k = a.padding, l = j.borderWidth, o = j.backgroundColor;
            if (a.itemX = a.initialItemX, a.itemY = a.initialItemY, a.offsetWidth = 0, a.lastItemY = 0, 
            !d) a.group = d = c.g("legend").attr({
                zIndex: 7
            }).add(), a.contentGroup = c.g().attr({
                zIndex: 1
            }).add(d), a.scrollGroup = c.g().add(a.contentGroup);
            if (a.renderTitle(), e = a.getAllItems(), ob(e, function(a, b) {
            ...
            a.legendWidth = g, a.legendHeight = h, p(e, function(b) {
                a.positionItem(b);
            }), f && d.align(q({
                width: g,
                height: h
        ...
        handleOverflow: function(a) {
            ...
            if ("horizontal" === e.layout && (f /= 2), g && (f = C(f, g)), n.length = 0, a > f && !e.useHTML) {
                if (this.clipHeight = h = f - 20 - this.titleHeight - this.padding, this.currentPage = m(this.currentPage, 1), 
                this.fullHeight = a, p(q, function(a, b) {
                    var c = a._legendItemPos[1], d = u(a.legendItem.getBBox().height), e = n.length;
                    if (!e || c - n[e - 1] > h && (s || c) !== n[e - 1]) n.push(s || c), e++;
                    b === q.length - 1 && c + d - n[e - 1] > h && n.push(c), c !== s && (s = c);
        ...
        scroll: function(a, b) {
            ...
            if (e > d && (e = d), e > 0) b !== t && Qa(b, this.chart), this.nav.attr({
                translateX: j,
        ...
        redraw: function(a) {
            ...
            if (g && this.getStacks(), this.hasCartesianSeries) {
        ...
        getContainer: function() {
            ...
            if (this.renderTo = a = b.renderTo, e = "highcharts-" + tb++, Fa(a)) this.renderTo = a = y.getElementById(a);
        ...
        getMargins: function() {
            ...
            if (this.resetMargins(), b = this.axisOffset, k && !r(d[0])) this.plotTop = v(this.plotTop, k + this.options.title.margin + a[0]);
            if (c.display && !e.floating) if ("right" === i) {
            ...
            } else if ("bottom" === j && !r(d[2])) this.marginBottom = v(this.marginBottom, c.legendHeight - h + f + a[2]);
        ...
        reflow: function(a) {
            ...
            if (!b.hasUserSize && e && f && (c === I || c === y)) {
                ...
                b.containerWidth = e, b.containerHeight = f;
            }
        },
        initReflow: function() {
        ...
        drawChartBox: function() {
            ...
            if (n = i + (a.shadow ? 8 : 0), i || j) if (e) e.animate(e.crisp({
                width: c - n,
                height: d - n
            })); else {
                if (e = {
        ...
        linkSeries: function() {
            ...
            p(b, function(a) {
                ...
                if (Fa(d) && (d = ":previous" === d ? a.series[b.index - 1] : a.get(d))) d.linkedSeries.push(b), 
                b.linkedParent = d;
            });
        },
        ...
        render: function() {
            ...
            if (a.setTitle(), a.legend = new lb(a, d.legend), a.getStacks(), p(b, function(a) {
                a.setScale();
            ...
            if (a.renderSeries(), e.items && p(e.items, function(b) {
        ...
        destroy: function() {
            ...
            if (p("title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,pointer,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer".split(","), function(b) {
                var c = a[b];
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender()) {
                if (a.getContainer(), D(a, "init"), a.resetMargins(), a.setChartSize(), a.propFromSeries(), 
    ...
    Ea.prototype = {
        init: function(a, b, c) {
            if (this.series = a, this.applyOptions(b, c), this.pointAttr = {}, a.options.colorByPoint && (b = a.options.colors || a.chart.options.colors, 
            this.color = this.color || b[a.colorCounter++], a.colorCounter === b.length)) a.colorCounter = 0;
            return a.chart.pointCount++, this;
        },
        applyOptions: function(a, b) {
            var c = this.series, d = c.pointValKey, a = Ea.prototype.optionsToObject.call(this, a);
            if (q(this, a), this.options = this.options ? q(this.options, a) : a, d) this.y = this[d];
            if (this.x === t && c) this.x = b === t ? c.autoIncrement() : b;
            return this;
        },
        optionsToObject: function(a) {
            var b = {}, c = this.series, d = c.pointArrayMap || [ "y" ], e = d.length, f = 0, g = 0;
            if ("number" == typeof a || null === a) b[d[0]] = a; else if (La(a)) {
                if (a.length > e) {
                    if (c = typeof a[0], "string" === c) b.name = a[0]; else if ("number" === c) b.x = a[0];
                    f++;
                }
                for (;e > g; ) b[d[g++]] = a[f++];
            } else if ("object" == typeof a) {
                if (b = a, a.dataLabels) c._hasPointLabels = !0;
        ...
        destroy: function() {
            ...
            if (a.pointCount--, b && (this.setState(), ja(b, this), !b.length)) a.hoverPoints = null;
        ...
        tooltipFormatter: function(a) {
            ...
            return p(b.pointArrayMap || [ "y" ], function(b) {
                if (b = "{point." + b, e || f) a = a.replace(b + "}", e + b + "}" + f);
                a = a.replace(b + "}", b + ":,." + d + "f}");
            }), Ia(a, {
                point: this,
                series: this.series
    ...
    O.prototype = {
        ...
        init: function(a, b) {
            ...
            if (c.chart = a, c.options = b = c.setOptions(b), c.linkedSeries = [], c.bindAxes(), 
            q(c, {
                name: b.name,
                state: "",
                pointAttr: {},
            ...
            if (c.getColor(), c.getSymbol(), p(c.parallelArrays, function(a) {
                c[a + "Data"] = [];
            }), c.setData(b.data, !1), c.isCartesian) a.hasCartesianSeries = !0;
            f.push(c), c._i = f.length - 1, ob(f, g), this.yAxis && ob(this.yAxis.series, g), 
            p(f, function(a, b) {
        ...
        bindAxes: function() {
            ...
            p(a.axisTypes || [], function(e) {
                p(c[e], function(c) {
                    if (d = c.options, b[e] === d.index || b[e] !== t && b[e] === d.id || b[e] === t && 0 === d.index) c.series.push(a), 
                    a[e] = c, c.isDirty = !0;
        ...
        getColor: function() {
            ...
            if (e = a.color || ba[this.type].color, !e && !a.colorByPoint) r(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color, 
            a = d.color++), e = c[a];
            this.color = e, d.wrapColor(c.length);
        },
        getSymbol: function() {
            var a = this.userOptions, b = this.options.marker, c = this.chart, d = c.options.symbols, c = c.counters;
            if (this.symbol = b.symbol, !this.symbol) r(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol, 
        ...
        setData: function(a, b, c, d) {
            ...
            if (h = a.length, b = m(b, !0), d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) p(a, function(a, b) {
                f[b].update(a, !1);
            }); else {
                ...
                e.isDirty = e.isDirtyData = j.isDirtyBox = !0, c = !1;
            }
            b && j.redraw(c);
        },
        processData: function(a) {
            ...
            if (l && this.sorted && (!j || d > j || this.forceCrop)) if (o = h.min, n = h.max, 
            b[d - 1] < o || b[0] > n) b = [], c = []; else if (b[0] < o || b[d - 1] > n) e = this.cropData(this.xData, this.yData, o, n), 
            b = e.xData, c = e.yData, e = e.start, f = !0, k = b.length;
            for (d = b.length - 1; d >= 0; d--) a = b[d] - b[d - 1], !f && b[d] > o && b[d] < n && k++, 
            a > 0 && (g === t || g > a) ? g = a : 0 > a && this.requireSorting && ra(15);
            if (this.cropped = f, this.cropStart = e, this.processedXData = b, this.processedYData = c, 
        ...
        generatePoints: function() {
            ...
            for (o = 0; g > o; o++) i = h + o, j ? l[o] = new f().init(this, [ d[o] ].concat(qa(e[o]))) : (b[i] ? k = b[i] : a[i] !== t && (b[i] = k = new f().init(this, a[i], d[o])), 
            l[o] = k);
            if (b && (g !== (c = b.length) || j)) for (o = 0; c > o; o++) if (o === h && !j && (o += g), 
        ...
        translate: function() {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = "between" === i || ha(i), k = a.threshold, a = 0; g > a; a++) {
                ...
                if (e.isLog && 0 >= n) l.y = n = null;
                if (l.plotX = c.translate(o, 0, 0, 0, 1, i, "flags" === this.type), b && this.visible && p && p[o]) p = p[o], 
                n = p.points[this.index + "," + a], s = n[0], n = n[1], 0 === s && (s = m(k, e.min)), 
                e.isLog && 0 >= s && (s = null), l.total = l.stackTotal = p.total, l.percentage = p.total && l.y / p.total * 100, 
                l.stackY = n, p.setOffset(this.pointXOffset || 0, this.barW || 0);
                l.yBottom = r(s) ? e.translate(s, 0, 1, 0, 1) : null, h && (n = this.modifyValue(n, l)), 
                l.plotY = "number" == typeof n && 1/0 !== n ? e.translate(n, 0, 1, 0, 1) : t, l.clientX = j ? c.translate(o, 0, 0, 0, 1) : l.plotX, 
                l.negative = l.y < (k || 0), l.category = d && d[l.x] !== t ? d[l.x] : l.x;
            }
            this.getSegments();
        },
        animate: function(a) {
            ...
            g = [ "_sharedClip", d.duration, d.easing, e.height ].join(","), a ? (a = b[g], 
            d = b[g + "m"], a || (b[g] = a = c.clipRect(q(e, {
                width: 0
        ...
        afterAnimate: function() {
            ...
            D(this, "afterAnimate"), setTimeout(function() {
        ...
        drawPoints: function() {
            ...
            if (d.enabled !== !1 || this._hasPointMarkers) for (f = b.length; f--; ) if (g = b[f], 
            d = T(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = s && i.enabled === t || i.enabled, 
            o = c.isInsidePlot(u(d), e, c.inverted), a && e !== t && !isNaN(e) && null !== g.y) {
                if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = m(i.symbol, this.symbol), 
                j = 0 === i.indexOf("url"), k) k[o ? "show" : "hide"](!0).animate(q({
                    x: d - h,
                    y: e - h
                }, k.symbolName ? {
                    width: 2 * h,
                    height: 2 * h
                } : {})); else if (o && (h > 0 || j)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h).attr(a).add(n);
        ...
        getAttribs: function() {
            ...
            j[""] = a.convertAttribs(c, f), p([ "hover", "select" ], function(b) {
                ...
                if (k = b.colorByPoint || i.color, i.options) for (m in l) r(c[l[m]]) && (k = !0);
                if (k) {
                    if (c = c || {}, k = [], d = c.states || {}, f = d.hover = d.hover || {}, !b.marker) f.color = f.color || !i.options.color && e.color || ya(i.color).brighten(f.brightness || e.brightness).get();
                    if (f = {
                        color: i.color
                    }, !s) f.fillColor = i.color;
                    if (!n) f.lineColor = i.color;
                    k[""] = a.convertAttribs(q(f, c), j[""]), k.hover = a.convertAttribs(d.hover, j.hover, k[""]), 
        ...
        destroy: function() {
            ...
            if (a.points = null, clearTimeout(a.animationTimeout), p("area,graph,dataLabelsGroup,group,markerGroup,tracker,graphNeg,areaNeg,posClip,negClip".split(","), function(b) {
        ...
        clipNeg: function() {
            ...
            if (d && (f || g)) {
                if (d = u(l.toPixels(a.threshold || 0, !0)), 0 > d && (k -= d), a = {
                    x: 0,
                    y: 0,
                    width: k,
                    height: d
        ...
        render: function() {
            ...
            if (c = a.plotGroup("group", "series", f, g, i), a.markerGroup = a.plotGroup("markerGroup", "markers", f, g, i), 
            ...
            a.isDirty = a.isDirtyData = !1, a.hasRendered = !0;
        },
        redraw: function() {
        ...
        if (this.options.stacking && (this.visible === !0 || this.chart.options.chart.ignoreHiddenSeries === !1)) {
            ...
            for (q = 0; d > q; q++) {
                if (r = a[q], u = b[q], p = this.index + "," + q, m = (n = j && f > u) ? i : h, 
            ...
            if ("percent" === e) k.usePercentage = !0;
            this.stackedYData = c, k.oldStacks = {};
        }
    }, O.prototype.setPercentStacks = function() {
        var a = this, b = a.stackKey, c = a.yAxis.stacks, d = a.processedXData;
        p([ b, "-" + b ], function(b) {
            for (var e, g, h, f = d.length; f--; ) if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], 
        ...
        showLoading: function(a) {
            ...
            if (this.loadingSpan.innerHTML = a || b.lang.loading, !this.loadingShown) G(c, {
                opacity: 0,
                display: "",
        ...
        update: function(a, b, c) {
            ...
            d.firePointEvent("update", {
                ...
                if (d.applyOptions(a), ca(a)) {
                    if (e.getAttribs(), f) a && a.marker && a.marker.symbol ? d.graphic = f.destroy() : f.attr(d.pointAttr[d.state || ""]);
                    if (a && a.dataLabels && d.dataLabel) d.dataLabel = d.dataLabel.destroy();
                }
                if (g = Da(d, h), e.updateParallelArrays(d, g), j.data[g] = d.options, e.isDirty = e.isDirtyData = !0, 
                !e.fixedBox && e.hasCartesianSeries) i.isDirtyBox = !0;
                "point" === j.legendType && i.legend.destroyItem(d), b && i.redraw(c);
            });
        },
        remove: function(a, b) {
        ...
        addPoint: function(a, b, c, d) {
            ...
            if (this.updateParallelArrays(d, "splice", h, 0, 0), this.updateParallelArrays(d, h), 
            j) j[g] = d.name;
            l.splice(h, 0, a), o && (this.data.splice(h, 0, null), this.processData()), "point" === e.legendType && this.generatePoints(), 
            c && (f[0] && f[0].remove ? f[0].remove(!1) : (f.shift(), this.updateParallelArrays(d, "shift"), 
            l.shift())), this.isDirtyData = this.isDirty = !0, b && (this.getAttribs(), i.redraw());
        },
        remove: function(a, b) {
        ...
        getSegments: function() {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                c.sort(function(a, b) {
                    ...
                    if (!k || g[a] && null !== g[a].y) g[a] ? b.push(g[a]) : (h = d.translate(a), l = f[a].percent ? f[a].total ? 100 * f[a].cum / f[a].total : 0 : f[a].cum, 
    ...
    if (F.area = pa, ba.spline = w(S), ga = ka(O, {
        type: "spline",
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                i > a && i > e ? (i = v(a, e), k = 2 * e - i) : a > i && e > i && (i = C(a, e), 
                k = 2 * e - i), k > g && k > e ? (k = v(g, e), i = 2 * e - k) : g > k && e > k && (k = C(g, e), 
        ...
        drawPoints: function() {
            ...
            p(a.points, function(i) {
                ...
                if (j !== t && !isNaN(j) && null !== i.y) f = i.shapeArgs, h = r(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = i.pointAttr[i.selected ? "select" : ""] || a.pointAttr[""], k ? (bb(k), 
                k.attr(h)[b.pointCount < e ? "animate" : "attr"](w(f))) : i.graphic = d[i.shapeType](f).attr(g).attr(h).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (k) i.graphic = k.destroy();
            });
        },
        animate: function(a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            if (aa) a ? (e.scaleY = .001, a = C(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), 
        ...
        pointClass: ka(Ea, {
            ...
            setVisible: function(a) {
                ...
                if (b.visible = b.options.visible = a = a === t ? !b.visible : a, c.options.data[Da(b, c.data)] = b.options, 
        ...
        translate: function(a) {
            ...
            for (this.getX = function(b, c) {
                return h = U.asin(C((b - a[1]) / (a[2] / 2 + l), 1)), a[0] + (c ? -1 : 1) * Z(h) * (a[2] / 2 + l);
            }, o = 0; n > o; o++) {
                if (p = k[o], f = j + b * i, !c || p.visible) b += p.percentage / 100;
        ...
        drawPoints: function() {
            ...
            p(a.points, function(h) {
                if (d = h.graphic, g = h.shapeArgs, f = h.shadowGroup, e && !f) f = h.shadowGroup = b.g("shadow").add(a.shadowGroup);
        ...
        i = a.plotGroup("dataLabelsGroup", "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && m(d.defer, !0) && (i.attr({
            ...
            if (f = b.options && b.options.dataLabels, e = m(f && f.enabled, g.enabled), l && !e) b.dataLabel = l.destroy(); else if (e) {
                ...
                d.style.color = m(d.color, d.style.color, a.color, "black"), l) {
                    if (r(h)) l.attr({
                        text: h
                    }), u = !1; else if (b.dataLabel = l = l.destroy(), p) b.connector = p.destroy();
                } else if (r(h)) {
                    l = {
        ...
        if (j = c.x, 0 > j) "right" === h ? b.align = "left" : b.x = -j, k = !0;
        if (j = c.x + d.width, j > g.plotWidth) "left" === h ? b.align = "right" : b.x = g.plotWidth - j, 
        k = !0;
        if (j = c.y, 0 > j) "bottom" === i ? b.verticalAlign = "top" : b.y = -j, k = !0;
        if (j = c.y + d.height, j > g.plotHeight) "top" === i ? b.verticalAlign = "bottom" : b.y = g.plotHeight - j, 
        k = !0;
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (D = 2; D--; ) {
                ...
                for (B = 0; I > B; B++) {
                    if (c = H[B], x = c.labelPos, t = c.dataLabel, G = c.visible === !1 ? "hidden" : "visible", 
                    c = x[1], l > 0) {
                        if (w = K.pop(), E = w.i, C = w.y, c > C && null !== b[E + 1] || C > c && null !== b[E - 1]) C = c;
                    } else C = c;
                    if (A = e.justify ? o[0] + (D ? -1 : 1) * (n + l) : a.getX(0 === E || E === b.length - 1 ? c : C, D), 
                    t._attr = {
                        visibility: G,
                        align: x[6]
                    }, t._pos = {
            ...
            if (0 === Ba(F) || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), r && g && p(this.points, function(b) {
                if (i = b.connector, x = b.labelPos, (t = b.dataLabel) && t._pos) G = t._attr.visibility, 
    ...
    if (S = R.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            j ? j.attr({
                ...
                if (a.addClass("highcharts-tracker").on("mouseover", n).on("mouseout", function(a) {
                    g.onTrackerMouseOut(a);
                }).css(l), $a) a.on("touchstart", n);
            }));
        }
    }, F.column) ga.prototype.drawTracker = S.drawTrackerPoint;
    ...
    q(lb.prototype, {
        ...
        zoom: function(a) {
            ...
            if (!a || a.resetSelection ? p(this.axes, function(a) {
                b = a.zoom();
            }) : p(a.xAxis.concat(a.yAxis), function(a) {
                var e = a.axis, h = e.isXAxis;
                if (c[h ? "zoomX" : "zoomY"] || c[h ? "pinchX" : "pinchY"]) b = e.zoom(a.min, a.max), 
                e.displayBtn && (d = !0);
            }), e = this.resetZoomButton, d && !e) this.showResetZoom(); else if (!d && ca(e)) this.resetZoomButton = e.destroy();
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                c.setState(a && "select"), b || p(e.getSelectedPoints(), function(a) {
                    if (a.selected && a !== c) a.selected = a.options.selected = !1, d.options.data[Da(a, d.data)] = a.options, 
        ...
        onMouseOver: function(a) {
            ...
            this.firePointEvent("mouseOver"), d && (!d.shared || b.noSharedTooltip) && d.refresh(this, a), 
            this.setState("hover"), c.hoverPoint = this;
        },
        onMouseOut: function() {
            var a = this.series.chart, b = a.hoverPoints;
            if (!b || -1 === Da(this, b)) this.firePointEvent("mouseOut"), this.setState(), 
            a.hoverPoint = null;
        },
        ...
        setState: function(a, b) {
            ...
            if (p = this.pointAttr[a] || e.pointAttr[a], !(a === this.state && !b || this.selected && "select" !== a || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
        ...
        onMouseOver: function() {
            ...
            this.options.events.mouseOver && D(this, "mouseOver"), this.setState("hover"), a.hoverSeries = this;
        },
        onMouseOut: function() {
            var a = this.options, b = this.chart, c = b.tooltip, d = b.hoverPoint;
            if (d) d.onMouseOut();
            this && a.events.mouseOut && D(this, "mouseOut"), c && !a.stickyTracking && (!c.shared || this.noSharedTooltip) && c.hide(), 
        ...
        setVisible: function(a, b) {
            ...
            if (f = (c.visible = a = c.userOptions.visible = a === t ? !h : a) ? "show" : "hide", 
            p([ "group", "dataLabelsGroup", "markerGroup", "tracker" ], function(a) {
                if (c[a]) c[a][f]();
            }), d.hoverSeries === c) c.onMouseOut();
            if (e && d.legend.colorizeItem(c, a), c.isDirty = !0, c.options.stacking && p(d.series, function(a) {
        ...
        setTooltipPoints: function(a) {
            ...
            if (this.options.enableMouseTracking !== !1 && !this.singularTooltips) {
                ...
                for (p(this.segments || this.points, function(a) {
                    b = b.concat(a);
        ...
        select: function(a) {
            if (this.selected = a = a === t ? !this.selected : a, this.checkbox) this.checkbox.checked = a;
    ...
    var y, A = f.Chart, t = f.addEvent, B = f.removeEvent, l = f.createElement, o = f.discardElement, v = f.css, k = f.merge, r = f.each, p = f.extend, D = Math.max, j = document, C = window, E = f.isTouchDevice, F = f.Renderer.prototype.symbols, s = f.getOptions();
    p(s.lang, {
        ...
        getSVG: function(b) {
            var d, c, z, h, a = this, g = k(a.options, b);
            ...
            }, j.body), c = a.renderTo.style.width, h = a.renderTo.style.height, c = g.exporting.sourceWidth || g.chart.width || /px$/.test(c) && parseInt(c, 10) || 600, 
            ...
            p(g.chart, {
                ...
                width: c,
                height: h
            }), g.exporting.enabled = !1, g.series = [], r(a.series, function(a) {
                z = k(a.options, {
                    animation: !1,
                    showCheckbox: !1,
                    visible: a.visible
                }), z.isInternal || g.series.push(z);
            }), d = new f.Chart(g, a.callback), r([ "xAxis", "yAxis" ], function(b) {
                r(a[b], function(a, c) {
                    var g = d[b][c], f = a.getExtremes(), h = f.userMin, f = f.userMax;
                    g && (void 0 !== h || void 0 !== f) && g.setExtremes(h, f, !0, !1);
                });
            ...
            }), c = c.replace(/(url\(#highcharts-[0-9]+)&quot;/g, "$1").replace(/&quot;/g, "'");
        },
        ...
        print: function() {
            ...
            if (!b.isPrinting) b.isPrinting = !0, r(h, function(a, b) {
                if (1 === a.nodeType) d[b] = a.style.display, a.style.display = "none";
            }), f.appendChild(a), C.focus(), C.print(), setTimeout(function() {
                c.appendChild(a), r(h, function(a, b) {
                    if (1 === a.nodeType) a.style.display = d[b];
                }), b.isPrinting = !1;
            }, 1e3);
        },
        contextMenu: function(b, a, d, c, f, h, g) {
            var w, x, o, e = this, k = e.options.navigation, q = k.menuItemStyle, m = e.chartWidth, n = e.chartHeight, j = "cache-" + b, i = e[j], u = D(f, h), s = function(a) {
            ...
            c + h + e.exportMenuHeight > n && "top" !== g.alignOptions.verticalAlign ? a.bottom = n - c - u + "px" : a.top = c + h - u + "px", 
            v(i, a), e.openMenu = !0;
        },
        addButton: function(b) {
            var g, e, a = this, d = a.renderer, c = k(a.options.navigation.buttonOptions, b), j = c.onclick, h = c.menuItems, l = {
            ...
            if (c.enabled !== !1) {
                var i, m = c.theme, n = m.states, o = n && n.hover, n = n && n.select;
                delete m.states, j ? i = function() {
                    j.apply(a, arguments);
                } : h && (i = function() {
                ...
                }), e.menuClassName = b.menuClassName || "highcharts-menu-" + a.btnCount++, c.symbol && (g = d.symbol(c.symbol, c.symbolX - q / 2, c.symbolY - q / 2, q, q).attr(p(l, {
                    "stroke-width": c.symbolStrokeWidth || 1,
                    zIndex: 1
                })).add(e)), e.add().align(p(c, {
                    width: e.width,
                    x: f.pick(c.x, y)
                }), !0, "spacingBox"), y += (e.width + c.buttonSpacing) * ("right" === c.align ? -1 : 1), 
                a.exportSVGElements.push(e, g);
            }
        },
        destroyExport: function(b) {
            var a, d, b = b.target;
            for (a = 0; a < b.exportSVGElements.length; a++) if (d = b.exportSVGElements[a]) d.onclick = d.ontouchstart = null, 
            b.exportSVGElements[a] = d.destroy();
            for (a = 0; a < b.exportDivElements.length; a++) d = b.exportDivElements[a], B(d, "mouseleave"), 
    ...
    function highchartsNGUtils() {
        return {
            indexOf: function(arr, find, i) {
                ...
                if (0 > i) i += arr.length;
                if (0 > i) i = 0;
                for (var n = arr.length; n > i; i++) if (i in arr && arr[i] === find) return i;
                return -1;
            },
            prependMethod: function(obj, method, func) {
                ...
                obj[method] = function() {
                    ...
                    if (func.apply(this, args), original) return original.apply(this, args); else ;
                };
            },
            deepExtend: function deepExtend(destination, source) {
                if (angular.isArray(source)) {
                    destination = angular.isArray(destination) ? destination : [];
                    for (var i = 0; i < source.length; i++) destination[i] = deepExtend(destination[i] || {}, source[i]);
                } else if (angular.isObject(source)) for (var property in source) destination[property] = deepExtend(destination[property] || {}, source[property]); else destination = source;
                return destination;
            }
        };
    }
    function highchart(highchartsNGUtils) {
        var seriesId = 0, ensureIds = function(series) {
            var changed = !1;
            return angular.forEach(series, function(s) {
                if (!angular.isDefined(s.id)) s.id = "series-" + seriesId++, changed = !0;
            }), changed;
        }, axisNames = [ "xAxis", "yAxis" ], getMergedOptions = function(scope, element, config) {
            ...
            if (config.options) mergedOptions = highchartsNGUtils.deepExtend(defaultOptions, config.options); else mergedOptions = defaultOptions;
            if (mergedOptions.chart.renderTo = element[0], angular.forEach(axisNames, function(axisName) {
                if (angular.isDefined(config[axisName])) if (mergedOptions[axisName] = angular.copy(config[axisName]), 
                angular.isDefined(config[axisName].currentMin) || angular.isDefined(config[axisName].currentMax)) highchartsNGUtils.prependMethod(mergedOptions.chart.events, "selection", function(e) {
                    var thisChart = this;
                    if (e[axisName]) scope.$apply(function() {
                ...
                }), highchartsNGUtils.prependMethod(mergedOptions.chart.events, "addSeries", function() {
                    scope.config[axisName].currentMin = this[axisName][0].min || scope.config[axisName].currentMin, 
                    scope.config[axisName].currentMax = this[axisName][0].max || scope.config[axisName].currentMax;
                });
            }), config.title) mergedOptions.title = config.title;
            if (config.subtitle) mergedOptions.subtitle = config.subtitle;
            if (config.credits) mergedOptions.credits = config.credits;
            if (config.size) {
                if (config.size.width) mergedOptions.chart.width = config.size.width;
                if (config.size.height) mergedOptions.chart.height = config.size.height;
            }
            return mergedOptions;
        }, updateZoom = function(axis, modelAxis) {
            var extremes = axis.getExtremes();
            if (modelAxis.currentMin !== extremes.dataMin || modelAxis.currentMax !== extremes.dataMax) axis.setExtremes(modelAxis.currentMin, modelAxis.currentMax, !1);
        }, processExtremes = function(chart, axis, axisName) {
            if (axis.currentMin || axis.currentMax) chart[axisName][0].setExtremes(axis.currentMin, axis.currentMax, !0);
        ...
        return {
            ...
            link: function(scope, element) {
                var prevSeriesOptions = {}, processSeries = function(series) {
                    var i, ids = [];
                    if (series) {
                        ...
                        if (angular.forEach(series, function(s) {
                            ...
                            if (chartSeries) if (!angular.equals(prevSeriesOptions[s.id], chartOptionsWithoutEasyOptions(s))) chartSeries.update(angular.copy(s), !1); else {
                                if (void 0 !== s.visible && chartSeries.visible !== s.visible) chartSeries.setVisible(s.visible, !1);
                                chartSeries.setData(angular.copy(s.data), !1);
                            } else chart.addSeries(angular.copy(s), !1);
                            prevSeriesOptions[s.id] = chartOptionsWithoutEasyOptions(s);
                        }), scope.config.noData) {
                            var chartContainsData = !1;
                            for (i = 0; i < series.length; i++) if (series[i].data && series[i].data.length > 0) {
                                chartContainsData = !0;
                                break;
                            }
                            if (!chartContainsData) chart.showLoading(scope.config.noData); else chart.hideLoading();
                        }
                    }
                    for (i = chart.series.length - 1; i >= 0; i--) {
                        var s = chart.series[i];
                        if ("highcharts-navigator-series" !== s.options.id && highchartsNGUtils.indexOf(ids, s.options.id) < 0) s.remove(!1);
                    }
                    return !0;
                }, chart = !1, initChart = function() {
                    if (chart) chart.destroy();
                    prevSeriesOptions = {};
                    var config = scope.config || {}, mergedOptions = getMergedOptions(scope, element, config), func = config.func || void 0;
                    chart = config.useHighStocks ? new Highcharts.StockChart(mergedOptions, func) : new Highcharts.Chart(mergedOptions, func);
                    for (var i = 0; i < axisNames.length; i++) if (config[axisNames[i]]) processExtremes(chart, config[axisNames[i]], axisNames[i]);
                    if (config.loading) chart.showLoading();
                };
                if (initChart(), scope.disableDataWatch) scope.$watchCollection("config.series", function(newSeries) {
                    processSeries(newSeries), chart.redraw();
                }); else scope.$watch("config.series", function(newSeries) {
                ...
                scope.$watch("config.title", function(newTitle) {
                    ...
                    if (loading) chart.showLoading(); else chart.hideLoading();
                }), scope.$watch("config.credits.enabled", function(enabled) {
                    if (enabled) chart.credits.show(); else if (chart.credits) chart.credits.hide();
                }), scope.$watch("config.useHighStocks", function(useHighStocks, oldUseHighStocks) {
                    if (useHighStocks !== oldUseHighStocks) initChart();
                }), angular.forEach(axisNames, function(axisName) {
                    scope.$watch("config." + axisName, function(newAxes, oldAxes) {
                        if (newAxes !== oldAxes) if (newAxes) chart[axisName][0].update(newAxes, !1), updateZoom(chart[axisName][0], angular.copy(newAxes)), 
                        chart.redraw();
                    }, !0);
                }), scope.$watch("config.options", function(newOptions, oldOptions, scope) {
                    if (newOptions !== oldOptions) initChart(), processSeries(scope.config.series), 
                    chart.redraw();
                }, !0), scope.$watch("config.size", function(newSize, oldSize) {
                    if (newSize !== oldSize) if (newSize) chart.setSize(newSize.width || void 0, newSize.height || void 0);
                }, !0), scope.$on("highchartsng.reflow", function() {
                    chart.reflow();
                }), scope.$on("$destroy", function() {
                    if (chart) chart.destroy(), setTimeout(function() {
                        element.remove();
                    }, 0);
                });
            }
