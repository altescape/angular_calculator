...
angular.module("myApp.directives", [ "LocalStorageModule" ]).directive("mainNav", function() {
    ...
    var FB_BASE_URL = "https://luminous-fire-1327.firebaseio.com", ref = new Firebase(FB_BASE_URL), authObj = $firebaseAuth(ref), authData = ref.getAuth(), num_uid = function() {
        ...
        if (authData) $rootScope.$broadcast("isLoggedInMessage", !0), $rootScope.$broadcast("isAuthorised", {
            success: !0,
            msg: authData.password.email
        ...
        authObj.$authWithPassword({
            ...
            $rootScope.$broadcast("authEvent", {
                success: !0,
                msg: result
            }), $rootScope.$broadcast("isLoggedInMessage", !0);
...
} ]).controller("AuthCtrl", [ "$rootScope", "$scope", "$sce", "Authorise", "$state", function($rootScope, $scope, $sce, Authorise, $state) {
    $scope.$on("authEvent", function(event, broadcast) {
        if ($scope.show_loader = !1, broadcast.success === !0) $scope.logged_in = !0, $state.go("info"); else $scope.reason = broadcast.msg;
    }), $scope.$on("isAuthorised", function(event, broadcast) {
        if (broadcast.success === !0) $scope.user = broadcast.msg, $scope.logged_in = !0; else $scope.show_loader = !1;
