...
angular.module("myApp.directives", [ "LocalStorageModule" ]).directive("mainNav", function() {
    ...
    if (authData) $scope.user_forms_ready = !0; else $state.go("auth");
    ...
    if (authData) $scope.user_forms_ready = !0, $scope.$emit("isLoggedInMessage", !0), 
    $scope.user = authData.password, $scope.logged_in = !0; else $scope.user_forms_ready = !0, 
    $scope.$emit("isLoggedInMessage", !1), $scope.logged_in = !1;
